    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Platform revamp}
          {Leading a engineering team to drive strategic design for the next generation of Data Platform  for \textbf{Chope}: managing business stakeholder communications, reinforce engineering best practices, improve data maturity across the organization}
    \resumeItemListEnd
