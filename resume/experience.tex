\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Platform revamp}
          {Leading a engineering team to drive strategic design for the next generation of Data Platform  for \textbf{Chope}: \emph{managing business stakeholder communications, reinforce engineering best practices, improve data maturity across the organization}}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Lake on-premises}
